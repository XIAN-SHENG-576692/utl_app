...
class DpvDetailEntityFile {
  ...
  DpvDetailEntityFile({
    ...
    final file = SimpleCsvFile(path: "$folderPath/AD5940_${dataName}_${entity.header.type}_detail_${DateTime.now().toFileNameFormat()}.csv");
    _write(file);
  }
  _write(SimpleCsvFile file) async {
    ...
    for(final current in entity.header.dpvParameters!
        .detailCurrents(

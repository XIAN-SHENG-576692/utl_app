...
import 'seat_cushion_sensor_data_manager.dart';

class SeatCushionSensorDataChangeNotifier extends ChangeNotifier {
  @protected
  final SeatCushionSensorDataManagerChangeNotifier seatCushionUnitsManagerChangeNotifier;
